...
func (m *recordingActionMutations) CreateRunwayClosure(auth aman.CommandContext, _ aman.CreateRunwayClosureCommand) (CommandMutation, error) {
	return m.mutation("create_runway_closure", auth)
}
