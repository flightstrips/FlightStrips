...
type GetPositionSnapshotParams struct {
	Session  int32
	Callsign string
}

type GetPositionSnapshotRow struct {
	Strip      Strip
	Assignment []byte
}

func (q *Queries) GetPositionSnapshot(ctx context.Context, arg GetPositionSnapshotParams) (GetPositionSnapshotRow, error) {
	row := q.db.QueryRow(ctx, getPositionSnapshot, arg.Session, arg.Callsign)
	var i GetPositionSnapshotRow
	err := row.Scan(
		&i.Strip.ID,
		&i.Strip.Version,
		&i.Strip.Callsign,
		...
		&i.Strip.Route,
		&i.Strip.Remarks,
		&i.Strip.AssignedSquawk,
		&i.Strip.Squawk,
		&i.Strip.Sid,
		&i.Strip.ClearedAltitude,
		&i.Strip.Heading,
		&i.Strip.AircraftType,
		&i.Strip.Runway,
		&i.Strip.RequestedAltitude,
		&i.Strip.Capabilities,
		&i.Strip.CommunicationType,
		&i.Strip.AircraftCategory,
		&i.Strip.Stand,
		&i.Strip.Sequence,
		&i.Strip.State,
		&i.Strip.Cleared,
		&i.Strip.Owner,
		&i.Strip.Bay,
		&i.Strip.PositionLatitude,
		&i.Strip.PositionLongitude,
		&i.Strip.PositionAltitude,
		&i.Strip.NextOwners,
		&i.Strip.PreviousOwners,
		&i.Strip.ReleasePoint,
		&i.Strip.Marked,
		&i.Strip.Registration,
		&i.Strip.TrackingController,
		&i.Strip.RunwayCleared,
		&i.Strip.UnexpectedChangeFields,
		&i.Strip.ControllerModifiedFields,
		&i.Strip.EngineType,
		&i.Strip.IsManual,
		&i.Strip.PersonsOnBoard,
		&i.Strip.FplType,
		&i.Strip.Language,
		&i.Strip.HasFp,
		&i.Strip.CdmData,
		&i.Strip.RunwayConfirmed,
		&i.Strip.PdcData,
		&i.Strip.ValidationStatus,
		&i.Strip.StartReq,
		&i.Strip.SpokenCallsign,
		&i.Strip.VatsimCid,
		&i.Strip.VatsimRevision,
		&i.Strip.VatsimSeenAt,
		&i.Strip.EuroscopeSeenAt,
		&i.Strip.ArrivalEta,
		&i.Strip.Star,
		&i.Strip.Hold,
		&i.Strip.HoldType,
...
func (q *Queries) InsertStrip(ctx context.Context, arg InsertStripParams) error {
	_, err := q.db.Exec(ctx, insertStrip,
		...
		arg.HoldType,
		arg.HoldEat,
		arg.NextDisplayLabel,
		arg.NextDisplayFrequency,
	)
	return err
}
...
func (q *Queries) SetRouteState(ctx context.Context, arg SetRouteStateParams) error {
	_, err := q.db.Exec(ctx, setRouteState,
		arg.NextOwners,
		arg.NextDisplayLabel,
		arg.NextDisplayFrequency,
		arg.Session,
...
SET version = version + 1,
    ...
    hold_type = $53,
    hold_eat = $54,
    next_display_label = $55,
    next_display_frequency = $56
WHERE callsign = $57 AND session = $58
`
...
const updateStripHoldByID = `-- name: UpdateStripHoldByID :execrows
UPDATE strips
SET hold      = $1,
    hold_type = $2,
    hold_eat  = $3,
...
WHERE callsign = $4 AND session = $5
  ...
  AND (version = $6 OR $6 IS NULL)
`

type UpdateStripHoldByIDParams struct {
	Hold     string
	HoldType string
	HoldEat  string
	Callsign string
...
func (q *Queries) UpdateStripHoldByID(ctx context.Context, arg UpdateStripHoldByIDParams) (int64, error) {
	result, err := q.db.Exec(ctx, updateStripHoldByID,
		arg.Hold,
		arg.HoldType,
		arg.HoldEat,
		arg.Callsign,
