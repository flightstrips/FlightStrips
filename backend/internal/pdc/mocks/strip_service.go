...
func (m *StripService) ApplyReleasePoint(ctx context.Context, session int32, callsign string, releasePoint string, clientPosition string) error {
...
func (m *StripService) RunwayConfirmation(ctx context.Context, session int32, callsign string) error {
	args := m.Called(ctx, session, callsign)
	return args.Error(0)
}
