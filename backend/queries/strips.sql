...
SET version = version + 1,
    ...
    controller_modified_fields = COALESCE(sqlc.arg(controller_modified_fields)::text[], '{}'::text[]),
    is_manual = sqlc.arg(is_manual),
    persons_on_board = sqlc.arg(persons_on_board),
    fpl_type = sqlc.arg(fpl_type),
...
-- name: UpdateTrackingController :execrows
UPDATE strips
