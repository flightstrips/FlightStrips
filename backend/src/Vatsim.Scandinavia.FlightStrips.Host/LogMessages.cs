...
public static partial class LogMessages
{
    ...
    [LoggerMessage(LogLevel.Information, "Controller {Callsign} subscribed for session {Airport} {Session}")]
    public static partial void ControllerSubscribed(this ILogger logger, string callsign, string airport, string session);

    [LoggerMessage(LogLevel.Information, "Controller unsubscribed for session {Airport} {Session}")]
    public static partial void ControllerUnsubscribed(this ILogger logger, string airport, string session);
