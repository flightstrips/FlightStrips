...
namespace FlightStrips::messages {
    ...
    private:
        ...
        void HandleEsAssumeOnlyEvent(const AssumeOnlyEvent& event) const;
        ...
        void WriteTopSkyHoldEat(EuroScopePlugIn::CFlightPlan flightPlan, const HoldEvent& event) const;
    };
