...
export enum ActionType {
  ...
  FrontendSendPrivateMessage = "send_private_message",
...
export interface ValidationStatus {
  ...
  custom_action?: ValidationAction;
}
...
export interface FrontendSendRunwayConfirmationEvent {
  type: ActionType.FrontendRunwayConfirmation;
  callsign: string;
}
...
export interface FrontendAtisUpdateEvent {
  ...
  metar: string;
  arr_atis_code: string;
  dep_atis_code: string;
}
...
export interface FrontendSendPrivateMessageEvent {
  type: ActionType.FrontendSendPrivateMessage;
  callsign: string;
  message: string;
}
...
export interface FrontendMissedApproachEvent {
  type: ActionType.FrontendMissedApproach;
  callsign: string;
}

export interface FrontendUpdateRunwayStatusEvent {
  type: ActionType.FrontendUpdateRunwayStatus;
  pair: string;
  status: string;
}

export interface FrontendAcknowledgeValidationStatusEvent {
  type: ActionType.FrontendAcknowledgeValidationStatus;
  callsign: string;
  activation_key: string;
}
