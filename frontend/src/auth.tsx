...
export default function Authentication() {
  return (
    <div className="min-h-svh w-screen flex items-center justify-center bg-gray-100">
        <div className="bg-primary w-full min-h-svh text-gray-100 text-6xl font-semibold flex items-center justify-center select-none">
            <h1>FlightStrips</h1>
        </div>
        <div className="bg-gray-100 w-full min-h-svh flex flex-col items-center justify-center text-primary relative">
            ...
            <div className="flex justify-between w-full max-w-2xl gap-4">
                <Button variant="default" size="lg" className="flex flex-col h-fit p-4 aspect-video w-54 font-semibold text-lg">
