...
export function AboutHero() {
  return (
    <section className="py-20 sm:py-28 px-6 sm:px-8 bg-cream">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8">
          {stats.map((stat) => (
            <div key={stat.label}>
              ...
              <p className="text-sm text-navy/70 mt-1">{stat.label}</p>
            </div>
          ))}
        </div>
      </div>
