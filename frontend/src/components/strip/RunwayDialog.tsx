...
const CLS_DIALOG_BG      = "bg-[#B3B3B3] border border-black p-0 w-[167px] max-w-none max-h-none gap-0 overflow-hidden [&>button]:hidden";
const CLS_PANEL          = "mx-[8px] my-[11px] border border-black flex flex-col justify-between h-fit";
const CLS_RWY_LIST       = "flex flex-col items-center gap-[12px] pt-[14px] pb-[16px]";
const CLS_RWY_BTN        = "w-[108px] h-[70px] bg-[#CCCCCC] text-black font-semibold text-[28px] shadow-[0_4px_4px_rgba(0,0,0,0.25)] outline-none active:brightness-90";
const CLS_RWY_BTN_ACTIVE = "w-[108px] h-[70px] bg-[#1BFF16] text-black font-semibold text-[28px] shadow-[0_4px_4px_rgba(0,0,0,0.25)] outline-none active:brightness-90";
const CLS_ESC_ROW        = "flex items-center justify-center pb-[24px]";
const CLS_ESC_BTN        = "w-[108px] h-[70px] bg-[#3F3F3F] text-white font-semibold text-[28px] shadow-[0_4px_4px_rgba(0,0,0,0.25)] outline-none active:brightness-75";
