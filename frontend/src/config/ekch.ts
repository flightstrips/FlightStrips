...
export const APRON_TAXI_POINTS: ClickPoint[] = [
  ...
  { label: "Q/Y", left: "50.51%", top: "53.27%" },
  { label: "Y/V", left: "58.50%", top: "71.49%" },
  { label: "Y/Q", left: "52.86%", top: "65.00%" },
  { label: "B", left: "58.66%", top: "86.93%" },
  { label: "B/Y", left: "61.00%", top: "79.00%" },
  { label: "R/W", left: "60.44%", top: "55.59%" },
  { label: "R/V", left: "60.97%", top: "65.67%" },
  { label: "S/W", left: "65.30%", top: "55.48%" },
  { label: "S/V", left: "65.44%", top: "65.67%" },
  { label: "DE-ICE B", left: "67.05%", top: "86.16%", width: "6.18%" },
  { label: "W/S", left: "70.60%", top: "54.37%" },
  { label: "V/S", left: "70.60%", top: "68.11%" },
  { label: "DE-ICE V", left: "77.00%", top: "67.50%", width: "6.18%" },
...
export const TAXI_MAP_POINTS: ClickPoint[] = [
  ...
  { label: "DEICE-B", left: "60.62%", top: "42.81%", width: "4.44%", visible: and(not(isApronOnline), isDep) },
  { label: "LINE 3", left: "27.03%", top: "47.00%", width: "4.44%" },
  { label: "LINE 2", left: "27.03%", top: "52.00%", width: "4.44%" },
  { label: "LINE 1", left: "27.03%", top: "57.00%", width: "4.44%" },
  ...
  { label: "B/C",    left: "42.26%", top: "80.60%", visible: and(onArr("22L"), isArr) },
  ...
  { label: "B/C",    left: "47.83%", top: "68.00%", visible: isDep },
  { label: "C/B",    left: "43.00%", top: "68.00%" },
  ...
  { label: "30/B",   left: "52.82%", top: "50.81%" },
  { label: "V/S",    left: "62.30%", top: "32.53%" },
  { label: (ctx) => onRwy("04R")(ctx) ? "12/04R" : "12/22L", left: "62.34%", top: "59.90%", width: "4.44%", type: "cl" },
  { label: (ctx) => onRwy("04R")(ctx) ? "30/04R" : "30/22L", left: "70.03%", top: "68.16%", width: "4.44%", type: "cl" },
