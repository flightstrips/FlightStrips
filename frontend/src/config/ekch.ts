...
export const TAXI_MAP_POINTS: ClickPoint[] = [
  { label: "K1/K",   left: "13.16%", top: "5.38%",  type: "hp" },
  { label: "A5",     left: "18.98%", top: "96.84%" },
  { label: "K2/K",   left: "20.12%", top: "10.73%", type: "hp" },
  { label: "K2/12",  left: "20.12%", top: "17.81%", type: "hp" },
  { label: "K3/Z",   left: "26.13%", top: "13.58%", type: "hp" },
  { label: "A4",     left: "26.13%", top: "84.76%" },
  { label: "K3/12",  left: "26.83%", top: "22.74%", type: "hp" },
  { label: "LINE 3", left: "27.03%", top: "47.74%", width: "80px", type: "hp" },
  { label: "LINE 2", left: "27.03%", top: "51.91%", width: "80px", type: "hp" },
  { label: "LINE 1", left: "27.03%", top: "56.08%", width: "80px", type: "hp" },
  ...
  { label: "12/22L", left: "62.34%", top: "59.90%", width: "80px", type: "hp" },
  { label: "30/22L", left: "70.03%", top: "68.16%", width: "80px", type: "hp" },
