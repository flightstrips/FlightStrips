  ...
  return (
    ...
    <div className={pageWrapper}>
      ...
      <div className={col}>
        ...
        <DropIndicatorBay bayId="FINAL" className={`h-[30%] ${scrollAreaBottom}`}>
          {finalStrips.map(s => (
        ...
        <DropIndicatorBay bayId="RWY-ARR" className={`h-[25%] ${scrollAreaBottom}`}>
          {rwyArrStrips.map(s => (
      ...
      <div className={col}>
        ...
        <SortableBay
          ...
          isDragDisabled={(strip) => isFlight(strip) && !!strip.owner && strip.owner !== myPosition}
          standalone={false}
          className={`h-[20%] ${scrollAreaBottom}`}
        >
          {(strip) => (
