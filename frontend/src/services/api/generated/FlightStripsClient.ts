...
> extends HttpClient<SecurityDataType> {
  api = {
     ...
     */
    baysDetail: (airport: string, params: RequestParams = {}) =>
  ...
  airport = {
     ...
     *
     * @tags OnlinePosition
     * @name OnlinePositionsDetail
     * @request GET:/{airport}/{session}/online-positions
     */
    onlinePositionsDetail: (
      airport: string,
      session: string,
      params: RequestParams = {},
    ) =>
